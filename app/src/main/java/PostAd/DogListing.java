...
//        String colors[] = {"Red","Blue","White","Yellow","Black", "Green","Purple","Orange","Grey"};
    ...
    public static class EditDogListing extends AppCompatActivity {
        EditText title,age,description,email,phone;
        Spinner breed_spinner,gender_spinner,size_spinner,district_spinner ,city_spinner;;
        Button postad_newlisting_btn;
    ...
    //        String colors[] = {"Red","Blue","White","Yellow","Black", "Green","Purple","Orange","Grey"};
        ...
        private AdapterView.OnItemSelectedListener district_listener = new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position > 0) {
                    final EditDogListing.District district =(EditDogListing.District) district_spinner.getItemAtPosition(position);
                    ArrayList<EditDogListing.City> tempStates = new ArrayList<>();

                //    tempStates.add(new EditDogListing.City(0, new PostAd.EditDogListing.District(0, "Select District"), "Select City"));

                    for (EditDogListing.City singleState : cities) {
                        if (singleState.getDistrict().getDistrictID() == district.getDistrictID()) {
                            tempStates.add(singleState);
                        }
                    }
        ...
        private class City implements Comparable<City> {
            ...
            private int cityID;
            private EditDogListing.District district;
            private String cityName;

            public City(int cityID, EditDogListing.District district, String cityName){
                this.cityID=cityID;
                this.district=district;
                this.cityName=cityName;
            }
            ...
            public EditDogListing.District getDistrict(){
                return district;
            }
            public String getCityName(){
                return cityName;
