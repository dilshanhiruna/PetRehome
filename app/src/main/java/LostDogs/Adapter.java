...
public class Adapter extends RecyclerView.Adapter<LostDogs.Adapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public LostDogs.Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.listing_ad_box_view,parent,false);
        return new LostDogs.Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LostDogs.Adapter.ViewHolder holder, int position) {
        ...
        holder.doglostdate.setText(doglostdate.get(position));
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), Display_LD_AD.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        TextView dogname,dogage,dogbreed,doglostdate,location,viewCount;
        ImageView img;
        ProgressBar progressBar_listings_img;
        public ViewHolder(@NonNull View itemView) {
            super(itemView);

            dogname =itemView.findViewById(R.id.ad_box_breed_txt);
            dogage =itemView.findViewById(R.id.ad_box_gender_txt);
            dogbreed =itemView.findViewById(R.id.ad_box_title_txt);
            doglostdate =itemView.findViewById(R.id.ad_box_title_txt);
