...
//        Toast.makeText(this, USERID+" "+IMGNUMBER,Toast.LENGTH_SHORT).show();
        ...
        DocumentReference documentReference =fstore.collection("LostDogsAds").document(USERID).collection("Listings").document(IMGNUMBER);
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                if (value != null && value.exists()){
                    ...
                    display_dog_name.setText(value.getString("dogname"));
                    display_dog_ad_breed.setText(value.getString("dogbreed"));
                    display_dog_ad_gender.setText(value.getString("doggender"));
                    display_dog_ad_age.setText(value.getString("dogage"));
                    display_dog_ad_size.setText(value.getString("dogsize"));
                    display_dog_ad_description.setText(value.getString("description"));
                    display_dog_ad_email.setText(value.getString("email"));
                    display_dog_ad_mobile.setText(value.getString("contactno"));
                    display_dog_ad_date.setText(value.getString("date"));
                    display_dog_ad_location.setText(value.getString("olocation"));
...
//                  display_dog_ad_image.setScaleType(ImageView.ScaleType.FIT_XY);
        ...
        display_dog_ad_edit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), EditLDListning.class);
